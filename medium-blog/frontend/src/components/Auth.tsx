...
import { SignupInput } from "@vintech1000/common-app";
...
function LabelledInput({
    ...
    return (
        <div>
            <label className="block mb-2 text-sm font-medium text-black pt-5">
                {label}
            </label>
            <input
                onChange={onChange}
                type={type || "text"}
                id="first_name"
                className="bg-gray-50 border border-gray-300 text-gray-9500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
